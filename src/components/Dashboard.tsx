...
import { LineChart, Line, BarChart, Bar, ComposedChart, AreaChart, Area, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Legend, ReferenceLine } from 'recharts';
...
export const Dashboard: React.FC = () => {
  ...
  const { chartData, maxCustomers, minCustomers } = useMemo(() => {
    ...
    // Handle empty cases for minC
    if (minC.value === Infinity) minC = { date: '', value: 0 };
              ...
              <div className="h-64 w-full" dir="ltr">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={chartData} margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
                    ...
                    />
                    <Bar dataKey="مشتریان" fill="#fcd34d" radius={[6, 6, 0, 0]} barSize={40}>
